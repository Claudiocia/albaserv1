...
<body>
    <div class="container-fluid fixed-top p-4 bg-blue">
        <div class="col-12 bg-blue">
            <div class="d-flex justify-content-start font-branc">
                <x-jet-application-mark width="26" />
            </div>
            <div class="d-flex justify-content-end font-branc">
                @if (Route::has('login'))
                    <div class="">
                        @auth
                            <a href="{{ url('/dashboard') }}" class="text-muted">Painel Administrativo</a>
                        @else
                            <a href="{{ route('login') }}" class="text-white">Login</a>

                            @if (Route::has('register'))
                                <a href="{{ route('register') }}" class="ms-4 text-white">Registro</a>
                            @endif
                        @endif
                    </div>
                @endif
    ...
    <div class="container-fluid my-6 pt-5 px-5">
