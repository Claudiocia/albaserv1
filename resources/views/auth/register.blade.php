        ...
        <div class="card-body">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3">
                    ...
                    <x-jet-input class="{{ $errors->has('cpf') ? 'is-invalid' : '' }}" type="text" name="cpf"
                ...
                <div class="mb-3">
                    <x-jet-label value="{{ __('Cadastro') }}" />

                    <x-jet-input class="{{ $errors->has('cadastro') ? 'is-invalid' : '' }}" type="text" name="cadastro"
                                 :value="old('cadastro')" required />
